...
namespace Servicestack.IntroSpec.Raml
{
    ...
    {
        private static readonly ILog log = LogManager.GetLogger(typeof(RamlCollectionGenerator));
        ...
        private RamlMethod GetActionMethod(ApiAction action, ApiResourceDocumentation resource, RamlWorkingSet ramlWorkingSet)
        {
            ...
            method.Responses = RamlResponseUtilities.GetResponses(action, resource);
            return method;
        }
